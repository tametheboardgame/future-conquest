...
const cities = read('major-cities-candidates-v0.1.geojson');
const airports = read('strategic-airports-candidates-v0.1.geojson');
const ports = read('ports-candidates-v0.1.geojson');
const width = 2400;
const height = 1800;
...
<text x="90" y="110" class="sub">Candidate evidence layers • v0.1 • Selection and terrain scoring follow</text>
...
<g transform="translate(90 1720)" class="legend"><circle class="city" r="6"/><text x="14" y="6">Major city candidate</text><circle class="airport" cx="220" r="5"/><text x="232" y="6">Strategic airport candidate</text><circle class="port" cx="520" r="5"/><text x="532" y="6">Port candidate</text><circle cx="700" r="9" fill="#101823" stroke="#f6eee0"/><text x="714" y="6">Territory strategic centre</text></g>
</svg>\n`;
fs.mkdirSync(outputRoot, { recursive: true });
fs.writeFileSync(path.join(outputRoot, 'strategic-geography-candidates-v0.1.svg'), svg);
