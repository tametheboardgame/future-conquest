...
// fallbacks. The known-good compressed source is split entirely into bounded
// connector-safe files. Exact encoded length is enforced before gunzip.
const assets = [
  {
    name: 'london-selected',
    expectedEncodedLength: 35_972,
    sourceFiles: [
      'london-selected.gltf.gz.b64.safe01',
      'london-selected.gltf.gz.b64.safe02',
      'london-selected.gltf.gz.b64.safe03',
      'london-selected.gltf.gz.b64.safe04',
      'london-selected.gltf.gz.b64.safe05',
      'london-selected.gltf.gz.b64.safe06'
    ]
  }
];
