...
test('a current version 5 save is inspected with its matching metadata', () => {
...
test('version 4, version 3 and version 2 saves migrate into version 5', () => {
